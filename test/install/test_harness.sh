...
snapshot_assets_count() {
  ...
  #  ../../snapshot/quill_0.36.0-SNAPSHOT-e5e847a_linux_arm64.deb
  #  ../../snapshot/quill_0.36.0-SNAPSHOT-e5e847a_linux_arm64.tar.gz
  #  ../../snapshot/quill_0.36.0-SNAPSHOT-e5e847a_linux_amd64.rpm
  #  ../../snapshot/quill_0.36.0-SNAPSHOT-e5e847a_darwin_arm64.tar.gz
  #  ../../snapshot/quill_0.36.0-SNAPSHOT-e5e847a_linux_amd64.deb
  #  ../../snapshot/quill_0.36.0-SNAPSHOT-e5e847a_linux_arm64.rpm
  #  ../../snapshot/quill_0.36.0-SNAPSHOT-e5e847a_darwin_amd64.zip
  #  ../../snapshot/quill_0.36.0-SNAPSHOT-e5e847a_windows_amd64.zip
  #  ../../snapshot/quill_0.36.0-SNAPSHOT-e5e847a_darwin_arm64.zip
  #  ../../snapshot/quill_0.36.0-SNAPSHOT-e5e847a_linux_amd64.tar.gz
  #  ../../snapshot/quill_0.36.0-SNAPSHOT-e5e847a_darwin_amd64.tar.gz

  echo "$(find ../../snapshot -maxdepth 1 -type f | grep 'quill_' | grep -v checksums | wc -l | tr -d '[:space:]')"
}
...
snapshot_assets_archive_count() {
  ...
  echo "$(find ../../snapshot -maxdepth 1  -type f | grep 'quill_' | grep 'tar\|zip' | wc -l | tr -d '[:space:]')"
}
