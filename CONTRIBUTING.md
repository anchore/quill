...
You should fork the Quill repo using the "Fork" button at the top right of the Quill GitHub [site](https://github.com/anchore/quill/). You will be doing your development in your fork, then submit a pull request to Quill. There are many resources how to use GitHub effectively, we will not cover those here.

## Adding a feature or fix

If you look at the Quill [Issue](https://github.com/anchore/quill/issues) there are plenty of bugs and feature requests. Maybe look at the [good first issue](https://github.com/anchore/quill/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) list if you're not sure where to start.
