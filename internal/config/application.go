...
// Application is the main application configuration.
type Application struct {
	...
	Output     string         `yaml:"output" json:"output" mapstructure:"output"` // --output, indicates what report output to shot
